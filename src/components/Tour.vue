  ...
  <div class="tour" @keydown.esc.stop="skip">
    <div class="tour-step" :class="'tour-step--' + step" :style="stepStyle">
      <div class="tour-step__inner" v-if="step === 'welcome'">
        <h2>Welcome!</h2>
        <p>The new <b>Honest Cash</b> Enhanced Editor is here!</p>
      ...
      <div class="tour-step__inner" v-else-if="step === 'editor'">
        ...
        <p>Honest Editor converts your Markdown to HTML in real-time.</p>
      ...
      <div class="tour-step__inner" v-else-if="step === 'explorer'">
        <h2>File explorer</h2>
        <p>Honest Editor can manage multiple files and folders in a workspace.</p>
      ...
      <div class="tour-step__inner" v-else-if="step === 'menu'">
        <h2>Do a lot more!</h2>
        <p>Honest Editor can also synchronize and publish your files, manage collaborative workspaces...</p>
