<template>
  <div class="modal" v-if="config" @keydown.esc.stop="onEscape" @keydown.tab="onTab" @focusin="onFocusInOut" @focusout="onFocusInOut">
    <div class="modal__sponsor-banner" v-if="false && !isSponsor">
      Honest Editor is <a class="not-tabbable" target="_blank" href="https://github.com/honest-cash/honest-editor-js/">open source</a>.
    </div>
